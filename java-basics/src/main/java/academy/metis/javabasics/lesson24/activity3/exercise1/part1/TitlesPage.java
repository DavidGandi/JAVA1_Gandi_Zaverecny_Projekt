    ...
    public void updateTitles(Object title) {
        ...
        if (title instanceof Book){
            ...
            try (BufferedWriter writer = new BufferedWriter(new FileWriter(BOOKS_FILE_PATH, true))){
                ...
                for (Book b : books) {
                    writer.write(String.format("%s,%s,%s,%d,%d,%d\n", b.getTitle(), b.getAuthorName(), b.getIsbn(), b.getPageCount(), b.getAvailableCopies(), b.getTitleId()));
                }
            }catch (IOException e){
                e.printStackTrace();
            }
        }
        if (title instanceof DVD) {
            //vycistenie suboru
            try (BufferedWriter writer = new BufferedWriter(new FileWriter(DVDS_FILE_PATH))){
            ...
            //opatovny zapis do suboru
            try (BufferedWriter writer = new BufferedWriter(new FileWriter(DVDS_FILE_PATH, true))){

                for (DVD d : dvds) {
                    writer.write(String.format("%s,%s,%d,%d,%d,%d\n", d.getTitle(), d.getAuthorName(), d.getNumberOfTracks(), d.getDurationInMinutes(), d.getAvailableCopies(), d.getTitleId()));
                }
            }catch (IOException e){
                e.printStackTrace();
            }
